...
<body>
	<footer id="fh5co-footer" class="fh5co-bg" style="background-image: url(<?= base_url('/dist/') ?>images/img_bg_1.jpg);" role="contentinfo">
		...
		<div class="container">
				...
				<div class="col-md-8">
					<h3>Kontak Kami</h3>
						<ul class="fh5co-footer-links">
							...
							<li class="url"><a href="https://www.instagram.com/gindabstm" target="_blank">Hotel.Hebat</a></li><br>
						</ul>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2022 Developed by Ginda Bustomi</small>
					</p>
				</div>
			</div>
		</div>
